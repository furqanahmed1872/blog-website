<script>
  ...
  const articles = [
    ...
    },
    {
      ...
      path: "Middle East / Leave a Comment",
      description: `Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit
          tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo. Sed
          non mauris vitae erat consequat auctor`
    },
...
<div class="container mx-auto px-4">
  ...
  <div class="mt-20 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 gap-6">
    ...
    <div class="flex flex-col col-span-1 lg:col-span-1 gap-6 w-full">
